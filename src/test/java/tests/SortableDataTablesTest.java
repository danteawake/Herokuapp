...
public class SortableDataTablesTest extends BaseTest {
    ...
    public void checkSortableDataTables() {
        ...
        softAssert.assertEquals(tableData.get(0).get(0).getText(), "Smith");
        softAssert.assertEquals(tableData.get(1).get(1).getText(), "Frank");
        softAssert.assertEquals(tableData.get(2).get(2).getText(), "jdoe@hotmail.com");
        softAssert.assertEquals(tableData.get(3).get(3).getText(), "$50.00");
        //Таблица
        System.out.println("----------------------------------------------------------------------------------------------------------");
